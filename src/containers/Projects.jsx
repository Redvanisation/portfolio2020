...
const Projects = () => (
  <section className="projects block has-text-centered">
    ...
    <div className="columns projects__container">
      {part1.map(prj => <Project name={prj.title} description={prj.description} live={prj.live} github={prj.github} />)}
    </div>
    <div className="columns projects__container">
      {part2.map(prj => <Project name={prj.title} description={prj.description} live={prj.live} github={prj.github} />)}
    </div>
  </section>
);
